        ...
        <>
            {
                isLink
                    ? <NavLink
                        to={to}
                        className={`relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-[var(--main-color)] border-2 border-[var(--main-color)] rounded-full hover:text-white group hover:bg-gray-50 ${className}`}
                        onClick={onClick}
                        type='submit'
                    >
